 ...
 *           created on Thursday, 16.02.2012 00:04:29, last modified on
 *Thursday, 16.02.2012 00:04:29
 *******************************************************************************************************/
...
typedef enum {
  ...
  UsageFault_IRQn = -10, /*!<   6  Usage Fault, i.e. Undef Instruction, Illegal
                            State Transition    */
...
typedef struct { /*!< MAC Structure */
  ...
  union {
    __IO uint32_t
        MAC_ALT_IACK;  /*!< Ethernet MAC Raw Interrupt Status/Acknowledge  */
...
typedef struct {       /*!< FLASH_CTRL Structure       */
  ...
  __IO uint32_t
      FCMISC; /*!< Flash Controller Masked Interrupt Status and Clear */
